...
public partial class SilverJewelry2023DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__BranchAc__349DA586D1ABA0A8");

            entity.ToTable("BranchAccount");

            entity.HasIndex(e => e.EmailAddress, "UQ__BranchAc__49A14740E409B4E3").IsUnique();
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BD67FEBB6");
        ...
        {
            entity.HasKey(e => e.SilverJewelryId).HasName("PK__SilverJe__1F1271976DC8A315");
